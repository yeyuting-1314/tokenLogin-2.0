...
public class UserController {
    ...
    //查询余额  redis中读取
    @GetMapping("/selectByUserName1")
    public Result selectByUserName1(@RequestParam("userName") String username , HttpServletRequest request){
        return Results.successWithData(userService.selectByUserName1(username , request) , BaseEnums.SUCCESS.code()) ;
    }
